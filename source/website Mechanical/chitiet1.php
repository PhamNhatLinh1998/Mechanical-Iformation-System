          ...
          <div class="row">
            ...
            <div class="col-lg-9">
              <div id="productMain" class="row">
                <div class="col-md-6">
                  <div data-slider-id="1" class="owl-carousel shop-detail-carousel">
                    <div class="item"> <img src="img/may1.jpg" alt="" class="img-fluid"></div>
                    <div class="item"> <img src="img/may1.jpg" alt="" class="img-fluid"></div>
                    <div class="item"> <img src="img/may1.jpg" alt="" class="img-fluid"></div>
                  </div>
                ...
                <div class="col-md-6">
                  <div class="box">
                    <h1 class="text-center">Máy bào mini</h1>
                    <p class="price">1.4000.000đ</p>
              ...
              <div id="details" class="box">
                ...
                <p>Máy bào bàn mini với thiết kế khung sẵn cộng với động cơ mạnh mẽ giúp máy chạy khỏe và vận hành tốc năng hơn. Máy bào với khung được kết hợp một cách chắc chắn và linh hoạt "hòa hợp" với bàn tay người dùng, giúp bạn có thể "lái" các đường bào một cách chuẩn xác hơn. Hệ thống điều chỉnh được tích hợp ngay trên những điểm cần thấy của máy và nếu như đã quen với sản phẩm này rồi thì bạn sẽ dễ dàng sử dụng một cách mượt mà nhất.</p>
                <h4>Xuất xứ</h4>
                <p>Đài Loan.</p>

          ...
          <div class="row">
            ...
            <div class="col-lg-9">
              <div id="productMain" class="row">
                <div class="col-md-6">
                  <div data-slider-id="1" class="owl-carousel shop-detail-carousel">
                    <div class="item"> <img src="img/may3.jpg" alt="" class="img-fluid"></div>
                    <div class="item"> <img src="img/may3.jpg" alt="" class="img-fluid"></div>
                    <div class="item"> <img src="img/may3.jpg" alt="" class="img-fluid"></div>
                  </div>
                ...
                <div class="col-md-6">
                  <div class="box">
                    <h1 class="text-center">Bộ máy công cụ gia công 6 trong 1</h1>
              ...
              <div id="details" class="box">
                ...
                <p>bộ máy công cụ gia công 6 trong 1 với 6 chức năng máy cưa, mài, khoan, tiện gỗ, tiện kim loại, phay, dùng để ra công chi tết nhỏ, đồ thủ công mỹ nghệ, mô hình nội thất mini.</p>
                <h4>Bộ sản phẩm bao gồm:</h4>
                <p>  1 Bộ máy đa năng 6 trong 1- 1 Sách hướng dẫn sử dụng và 1 DVD hướng dẫn</p>

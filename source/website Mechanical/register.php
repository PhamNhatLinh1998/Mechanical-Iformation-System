            ...
            <div class="col-lg-12">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li aria-current="page" class="breadcrumb-item active">Tạo Tài Khoản Mới / Đăng Nhập</li>
                </ol>
              </nav>
            </div>
            <div class="col-lg-6">
              <div class="box">
                ...
                <form action="customer-orders.html" method="post">
                  ...
                  <div class="text-center">
                    <button type="submit" class="btn btn-primary"><i class="fa fa-user-md"></i> Đăng Kí</button>
                  </div>
                </form>
              </div>
            </div>
